...
for(x in 1:nsim){
  ...
  result=Optimize_MM_N(file=name,theta = theta,gamma=1,L=L,n=40,ER=T,Pop=T,Boxr=c(1,1),pop_vect=NA,NC=1,M_a=M,mut=T,Correct_window=T)
...
title(" Theoretical convergence of MSMC ")
